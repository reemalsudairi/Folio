...
class _ProfilePageState extends State<ProfilePage> {
  ...
  String _username = '';
  String _email = '';
  String _userId = ''; // Store userId to pass to child widgets
      ...
      FirebaseFirestore.instance
        ...
        if (userDoc.exists) {
          ...
          setState(() {
            ...
            // Dynamically assign pages after userId is fetched
            _pages = [
              LibraryPage(userId: _userId),
              ClubsPage(),
              ReviewsPage(readerId: _userId, currentUserId: _userId), // Pass the correct userId
            ];
          });
        }
      });
