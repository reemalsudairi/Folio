...
class OtherEditProfile extends StatefulWidget {
  final String userId;
  final String name;
  final String bio;
  ...
  @override
  _OtherEditProfileState createState() => _OtherEditProfileState();
}

class _OtherEditProfileState extends State<OtherEditProfile> {
