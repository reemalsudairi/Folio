        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(
                              height: 12), // Space between title and author
                          Text(
                            'By $bookAuthor',
                            style: TextStyle(
              ...
              Center(
                child: Row(
                  mainAxisSize: MainAxisSize.min, // Set min to prevent overflow
                  children: [
                    Text(
                      'Rate it',
                      style: TextStyle(
                    ...
                    SizedBox(width: 8), // Reduced space between text and stars
                    Flexible(
                      child: RatingBar.builder(
                        ...
                        itemBuilder: (context, _) => Icon(
                          Icons.star_rounded,
                          color:
                              rating > 0 ? Color(0xFFF790AD) : Colors.grey[350],
                          size: 50, // Reduced star size to avoid overflow
                        ),
                        itemSize: 40,
              ...
              TextField(
                ...
                inputFormatters: [
                  FilteringTextInputFormatter.deny(
                      RegExp(r'^\s*$')), // Prevent whitespace-only input
                ],
                decoration: InputDecoration(
                  ...
                  border: OutlineInputBorder(
                    ...
                    borderSide: BorderSide(
                        color: Color(0xFFF790AD)), // Pink border by default
                  ),
                  enabledBorder: OutlineInputBorder(
                    borderRadius: BorderRadius.circular(15.0),
                    borderSide: BorderSide(
                        color:
                            Color(0xFFF790AD)), // Pink border even before focus
                  ),
                  focusedBorder: OutlineInputBorder(
                    borderRadius: BorderRadius.circular(15.0),
                    borderSide: BorderSide(
                        color: Color(0xFFF790AD)), // Pink border on focus
                  ),
                ),
                onChanged: (value) {
              ...
              Center(
                child: ElevatedButton(
                  style: ElevatedButton.styleFrom(
                    backgroundColor:
                        Color(0xFFF790AD), // Pink color for the button
                    padding: EdgeInsets.symmetric(
                        vertical: 15,
                        horizontal: 30), // Increased button padding
