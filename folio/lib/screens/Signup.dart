                          ...
                          children: [
                            ...
                            Column(
                              crossAxisAlignment: CrossAxisAlignment
                                  .start, // Align labels to the start (left)
                              children: [
                                const Text(
                                  "Username",
                                  style: TextStyle(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    border: OutlineInputBorder(
                                      ...
                                      borderSide: const BorderSide(
                                          color: Color(
                                              0xFFF790AD)), // Pink border initially
                                    ),
                                    enabledBorder: OutlineInputBorder(
                                      borderRadius: BorderRadius.circular(40),
                                      borderSide: const BorderSide(
                                          color: Color(
                                              0xFFF790AD)), // Pink border when enabled
                                    ),
                                    focusedBorder: OutlineInputBorder(
                                      borderRadius: BorderRadius.circular(40),
                                      borderSide: const BorderSide(
                                          color: Color(
                                              0xFFF790AD)), // Pink border when focused
                                    ),
                                    suffixIcon: Padding(
                                      padding: const EdgeInsets.only(
                                          right: 45.0,
                                          top: 10.0), // Right padding
                                      child: RichText(
                                        text: TextSpan(
                                          text: '*',
                                          style: TextStyle(
                                ...
                                TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    suffixIcon: Padding(
                                      padding: const EdgeInsets.only(
                                          right:
                                              8.0), // Right padding for the icon
                                      child: Row(
