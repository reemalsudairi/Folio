...
class _RecommendationPageState extends State<RecommendationPage> {
  ...
  Future<void> _fetchRecommendedBooks() async {
    ...
    try {
      ...
      for (String lang in widget.answers["What language do you prefer?"]
              ?.map((e) => e.toLowerCase()) ??
          ["en"]) {
        for (Map<String, dynamic> book in widget.books) {
          final String bookId = book['id'] ?? '';
          debugPrint('Processing Book ID for $lang: $bookId');
          if (bookId.isNotEmpty) {
            final bookDetails =
                await _googleBooksService.getBookDetails(bookId);
      ...
      fetchedBooks = fetchedBooks.toSet().toList();
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 10),
              const Text(
                'You’ll lose any unsaved books if you leave this screen. Do you want to exit?',
                style: TextStyle(
                  color: Colors.white,
                  fontSize: 16,
                ),
                        ...
                        Expanded(
                          child: Column(
                            children: [
                                  ...
                                  itemBuilder: (context, index) {
                                    ...
                                    return Padding(
                                      padding: const EdgeInsets.only(
                                          left: 8.0, right: 8.0, bottom: 50.0),
                                                  ...
                                                  ClipRRect(
                                                    ...
                                                    child: Image.network(
                                                      book['volumeInfo']
                                                          ...
                                                          '',
                                                      height:
                                                          300, // Fixed height for book cover
                                                      fit: BoxFit.cover,
                              ...
                              const SizedBox(
                                  height:
                                      16), // Adjust spacing between content and indicator

                              const SizedBox(
                                  height:
                                      16), // Add padding below the indicators if needed
                            ],
                          ),
                        ),
                      ],
